...
from core.apis.assignments import student_assignments_resources,teachers_assignments_resources
...
app.register_blueprint(teachers_assignments_resources, url_prefix='/teacher',name="teachers")
